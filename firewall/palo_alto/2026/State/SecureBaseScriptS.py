...
set address PrivIP192 ip-netmask 192.168.0/16
...
set rulebase security rules EcommWebIntrazone action allow from Public to User source UbuntuWebPriv destination any
set rulebase security rules EcommWebIntrazone action allow from Public to Internal source UbuntuWebPriv destination any
